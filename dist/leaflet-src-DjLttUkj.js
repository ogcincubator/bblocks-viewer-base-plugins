 ...
 */
var Ko = Vt.exports, pn;
function Yo() {
  return pn || (pn = 1, (function(J, qt) {
    (function(l, nt) {
      nt(qt);
    })(Ko, (function(l) {
      var nt = "1.9.4";
      ...
      var lt = Object.create || /* @__PURE__ */ (function() {
        function t() {
        }
        return function(e) {
      ...
      ot.extend = function(t) {
        ...
        }, i = e.__super__ = this.prototype, n = lt(i);
        n.constructor = e, e.prototype = n;
        for (var o in this)
          Object.prototype.hasOwnProperty.call(this, o) && o !== "prototype" && o !== "__super__" && (e[o] = this[o]);
        return t.statics && x(e, t.statics), t.includes && (wn(t.includes), x.apply(null, [n].concat(t.includes))), x(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? lt(i.options) : {}, x(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
      ...
      var st = {
        ...
        wrapLatLng: function(t) {
          var e = this.wrapLng ? zt(t.lng, this.wrapLng, !0) : t.lng, i = this.wrapLat ? zt(t.lat, this.wrapLat, !0) : t.lat, n = t.alt;
          return new b(i, e, n);
        },
      ...
      var we = document.documentElement.style, Kt = "ActiveXObject" in window, Pn = Kt && !document.addEventListener, hi = "msLaunchUri" in navigator && !("documentMode" in document), xe = Q("webkit"), ui = Q("android"), li = Q("android 2") || Q("android 3"), Ln = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Tn = ui && Q("Google") && Ln < 537 && !("AudioNode" in window), Pe = !!window.opera, ci = !hi && Q("chrome"), fi = Q("gecko") && !xe && !Pe && !Kt, bn = !ci && Q("safari"), di = Q("phantom"), _i = "OTransition" in we, Mn = navigator.platform.indexOf("Win") === 0, mi = Kt && "transition" in we, Le = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !li, pi = "MozPerspective" in we, Sn = !window.L_DISABLE_3D && (mi || Le || pi) && !_i && !di, Zt = typeof orientation < "u" || Q("mobile"), Cn = Zt && xe, zn = Zt && Le, vi = !window.PointerEvent && window.MSPointerEvent, gi = !!(window.PointerEvent || vi), yi = "ontouchstart" in window || !!window.TouchEvent, kn = !window.L_NO_TOUCH && (yi || gi), En = Zt && Pe, Zn = Zt && fi, On = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, In = (function() {
        var t = !1;
        try {
      ...
      function v(t, e) {
        if (t.classList !== void 0)
          for (var i = _t(e), n = 0, o = i.length; n < o; n++)
            t.classList.add(i[n]);
        else if (!Se(t, e)) {
          var s = Jt(t);
          Ce(t, (s ? s + " " : "") + e);
      ...
      if ("onselectstart" in document)
        ...
        At = function() {
          ...
          Nt && (document.documentElement.style[Nt] = ze, ze = void 0);
        };
      }
      function ke() {
      ...
      function M(t, e, i, n) {
        if (arguments.length === 1)
          ...
          for (var o in e)
            Ne(t, o, e[o], i);
        else if (e = _t(e), arguments.length === 2)
          ki(t, function(a) {
            return _e(e, a) !== -1;
          });
        else
      ...
      function Be(t, e, i, n) {
        ...
        }, t.addEventListener(Ae[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[tt] = t[tt] || {}, t[tt][o] = s;
      }
      function Ne(t, e, i, n, o) {
        ...
        if (!s)
          return this;
        !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? Hn(t, e, s) : f.touch && e === "dblclick" ? Yn(t, s) : "removeEventListener" in t ? t.removeEventListener(Ae[e] || e, s, !1) : t.detachEvent("on" + e, s), t[tt][o] = null;
      }
      function vt(t) {
        return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
      }
      function Re(t) {
        return Be(t, "wheel", vt), this;
      }
      function Rt(t) {
      ...
      var $n = f.linux && f.chrome ? window.devicePixelRatio : f.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
      function Oi(t) {
        return f.edge ? t.wheelDeltaY / 2 : (
          // Don't trust window-geometry-based delta
          t.deltaY && t.deltaMode === 0 ? -t.deltaY / $n : (
            // Pixels
      ...
      var Ai = Y.extend({
        ...
        _initLayout: function() {
          ...
          e.setAttribute("aria-haspopup", !0), Rt(e), Re(e);
      ...
      Y.Layers = Ai, Y.Zoom = Fe, Y.Scale = Bi, Y.Attribution = He, Dt.layers = eo, Dt.zoom = io, Dt.scale = no, Dt.attribution = so;
      var et = ot.extend({
        initialize: function(t) {
          this._map = t;
        },
      ...
      var ro = { Events: U }, Ni = f.touch ? "touchstart mousedown" : "mousedown", ft = kt.extend({
        options: {
          // @section
        ...
        _onDown: function(t) {
          if (this._enabled && (this._moved = !1, !Se(this._element, "leaflet-zoom-anim"))) {
            ...
            if (!(ft._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (ft._dragging = this, this._preventOutline && Oe(this._element), ke(), At(), !this._moving)) {
              this.fire("down");
              var e = t.touches ? t.touches[0] : t, i = zi(this._element);
              this._startPoint = new m(e.clientX, e.clientY), this._startPos = pt(this._element), this._parentScale = Ie(i);
        ...
        finishDrag: function(t) {
          Z(document.body, "leaflet-dragging"), this._lastTarget && (Z(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), M(document, "mousemove touchmove", this._onMove, this), M(document, "mouseup touchend touchcancel", this._onUp, this), Ee(), Bt();
      ...
      function Ri(t, e, i) {
        ...
        for (a = 0; a < 4; a++) {
          for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
            h = t[s], u = t[r], h._code & d ? u._code & d || (g = ee(u, h, d, e, i), g._code = yt(g, e), n.push(g)) : (u._code & d && (g = ee(u, h, d, e, i), g._code = yt(g, e), n.push(g)), n.push(h));
          t = n;
        }
        return t;
      }
      ...
      function Ue(t, e, i, n, o) {
        var s = 0, r, a, h;
        for (a = n + 1; a <= o - 1; a++)
          h = Ft(t[a], t[n], t[o], !0), h > s && (r = a, s = h);
      ...
      function Ui(t, e, i, n, o) {
        var s = n ? Wi : yt(t, i), r = yt(e, i), a, h, u;
        for (Wi = r; ; ) {
          if (!(s | r))
            return [t, e];
          if (s & r)
            return !1;
          a = s || r, h = ee(t, e, a, i, o), u = yt(h, i), a === s ? (t = h, s = u) : (e = h, r = u);
        }
      }
      ...
      var fo = {
        ...
        code: "EPSG:4326",
        projection: Ge,
        transformation: Et(1 / 180, 1, -1 / 180, 0.5)
      }), po = x({}, st, {
        projection: Ge,
      ...
      st.Earth = ct, st.EPSG3395 = mo, st.EPSG3857 = ye, st.EPSG900913 = xn, st.EPSG4326 = qi, st.Simple = po;
      var X = kt.extend({
      ...
      var Ht = Tt.extend({
        ...
        _detectIconPath: function() {
          var t = T("div", "leaflet-default-icon-path", document.body), e = It(t, "background-image") || It(t, "backgroundImage");
        ...
        _adjustPan: function(t) {
          var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = pt(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = F(
      ...
      var qe = ne.extend({
        ...
        _project: function() {
          ...
          if (n.distance === ct.distance) {
            var o = Math.PI / 180, s = this._mRadius / ct.R / o, r = i.project([e + s, t]), a = i.project([e - s, t]), h = r.add(a).divideBy(2), u = i.unproject(h).lat, c = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(u * o)) / (Math.cos(e * o) * Math.cos(u * o))) / o;
      ...
      function oe(t, e) {
        ...
        switch (i.type) {
          ...
          case "MultiLineString":
            return h = se(n, i.type === "LineString" ? 0 : 1, r), new at(h, e);
          case "Polygon":
          case "MultiPolygon":
            return h = se(n, i.type === "Polygon" ? 1 : 2, r), new bt(h, e);
      ...
      ie.include(Ye), qe.include(Ye), ne.include(Ye), at.include({
        toGeoJSON: function(t) {
      ...
      var ue = it.extend({
        ...
        onAdd: function(t) {
          it.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof dt || this._source.on("preclick", vt));
        },
        onRemove: function(t) {
          it.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof dt || this._source.off("preclick", vt));
        },
        getEvents: function() {
        ...
        _initLayout: function() {
          ...
          if (this._contentNode = T("div", t + "-content", i), Rt(e), Re(this._contentNode), p(e, "contextmenu", vt), this._tipContainer = T("div", t + "-tip-container", e), this._tip = T("div", t + "-tip", this._tipContainer), this.options.closeButton) {
        ...
        _adjustPan: function() {
          if (this.options.autoPan) {
            ...
            var t = this._map, e = parseInt(It(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new m(this._containerLeft, -i - this._containerBottom);
      ...
      var le = it.extend({
        ...
        onAdd: function(t) {
          it.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", { tooltip: this }), this._source && (this.addEventParent(this._source), this._source.fire("tooltipopen", { tooltip: this }, !0));
        },
        onRemove: function(t) {
          it.prototype.onRemove.call(this, t), t.fire("tooltipclose", { tooltip: this }), this._source && (this.removeEventParent(this._source), this._source.fire("tooltipclose", { tooltip: this }, !0));
        },
        getEvents: function() {
          var t = it.prototype.getEvents.call(this);
      ...
      var Wt = X.extend({
        ...
        _wrapCoords: function(t) {
          var e = new m(
            this._wrapX ? zt(t.x, this._wrapX) : t.x,
            this._wrapY ? zt(t.y, this._wrapY) : t.y
          );
          return e.z = t.z, e;
        },
      ...
      var St = Wt.extend({
        ...
        _removeTile: function(t) {
          var e = this._tiles[t];
          if (e)
            return e.el.setAttribute("src", jt), Wt.prototype._removeTile.call(this, t);
        },
        _tileReady: function(t, e, i) {
          if (!(!this._map || i && i.getAttribute("src") === jt))
            return Wt.prototype._tileReady.call(this, t, e, i);
        }
      });
      function Qi(t, e) {
        return new St(t, e);
      ...
      var tn = St.extend({
        ...
        getTileUrl: function(t) {
          var e = this._tileCoordsToNwSe(t), i = this._crs, n = F(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === qi ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = St.prototype.getTileUrl.call(this, t);
      ...
      Gt.create = ce, Gt.pointsToPath = ai, ht.geometryToLayer = oe, ht.coordsToLatLng = je, ht.coordsToLatLngs = se, ht.latLngToCoords = Ke, ht.latLngsToCoords = re, ht.getFeature = Mt, ht.asFeature = ae, w.mergeOptions({
      ...
      var rn = et.extend({
        ...
        _onMouseDown: function(t) {
          if (!t.shiftKey || t.which !== 1 && t.button !== 1)
            return !1;
          this._clearDeferredResetState(), this._resetState(), At(), ke(), this._startPoint = this._map.mouseEventToContainerPoint(t), p(document, {
            contextmenu: gt,
        ...
        _finish: function() {
          this._moved && (k(this._box), Z(this._container, "leaflet-crosshair")), Bt(), Ee(), M(document, {
            contextmenu: gt,
            mousemove: this._onMouseMove,
            mouseup: this._onMouseUp,
            keydown: this._onKeyDown
      ...
      w.addInitHook("addHandler", "touchZoom", fn), w.BoxZoom = rn, w.DoubleClickZoom = an, w.Drag = hn, w.Keyboard = un, w.ScrollWheelZoom = ln, w.TapHold = cn, w.TouchZoom = fn, l.Bounds = z, l.Browser = f, l.CRS = st, l.Canvas = en, l.Circle = qe, l.CircleMarker = ne, l.Class = ot, l.Control = Y, l.DivIcon = $i, l.DivOverlay = it, l.DomEvent = Qn, l.DomUtil = Jn, l.Draggable = ft, l.Evented = kt, l.FeatureGroup = rt, l.GeoJSON = ht, l.GridLayer = Wt, l.Handler = et, l.Icon = Tt, l.ImageOverlay = he, l.LatLng = b, l.LatLngBounds = H, l.Layer = X, l.LayerGroup = Lt, l.LineUtil = fo, l.Map = w, l.Marker = ie, l.Mixin = ro, l.Path = dt, l.Point = m, l.PolyUtil = ao, l.Polygon = bt, l.Polyline = at, l.Popup = ue, l.PosAnimation = Ii, l.Projection = _o, l.Rectangle = sn, l.Renderer = ut, l.SVG = Gt, l.SVGOverlay = Ji, l.TileLayer = St, l.Tooltip = le, l.Transformation = ge, l.Util = yn, l.VideoOverlay = Xi, l.bind = S, l.bounds = F, l.canvas = nn, l.circle = Po, l.circleMarker = xo, l.control = Dt, l.divIcon = Eo, l.extend = x, l.featureGroup = go, l.geoJSON = Yi, l.geoJson = bo, l.gridLayer = Zo, l.icon = yo, l.imageOverlay = Mo, l.latLng = y, l.latLngBounds = O, l.layerGroup = vo, l.map = to, l.marker = wo, l.point = _, l.polygon = To, l.polyline = Lo, l.popup = zo, l.rectangle = Ao, l.setOptions = C, l.stamp = P, l.svg = on, l.svgOverlay = Co, l.tileLayer = Qi, l.tooltip = ko, l.transformation = Et, l.version = nt, l.videoOverlay = So;
      var No = window.L;
...
var vn = Yo();
const Xo = /* @__PURE__ */ jo(vn), Jo = /* @__PURE__ */ qo({
  __proto__: null,
  default: Xo
}, [vn]);
export {
